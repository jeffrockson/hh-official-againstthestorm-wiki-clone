...
for _, building in pairs(campsDataModel.dataTable) do
    building[campsDataModel.schema.CATEGORY2] = "Gathering Camp"
    building[campsDataModel.schema.IS_PROVIDING_SERVICES] = false
end

campsDataModel.schema.RECIPE.PRODUCTION_TIME = "gatheringTime"

--IMPORTANT: The data structure has one fewer levels, like RECIPE > PRODUCT_ID
campsDataModel.schema.RECIPE.PRODUCT.ID = "seekedResource"
...
campsDataModel.getIDsAndRecipesWhereProductID = getIDsAndRecipesWhereProductID
campsDataModel.getIDsAndRecipesWhereProductIDAndBuildingID = getIDsAndRecipesWhereProductIDAndBuildingID

--Override recipe data retrieval interface
campsDataModel.getRecipeGrade = getRecipeGrade
campsDataModel.getRecipeProductID = getRecipeProductID
campsDataModel.getRecipeProductAmount = getRecipeProductAmount
