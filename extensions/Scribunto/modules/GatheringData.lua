...
for _, building in pairs(gatheringDataModel.dataTable) do
    building[gatheringDataModel.schema.CATEGORY2] = "Gathering Camp"
    building[gatheringDataModel.schema.IS_PROVIDING_SERVICES] = false
end

gatheringDataModel.schema.RECIPE.PRODUCTION_TIME = "gatheringTime"

--IMPORTANT: The data structure has one fewer levels, like RECIPE > PRODUCT_ID
gatheringDataModel.schema.RECIPE.PRODUCT.ID = "seekedDeposits"
...
gatheringDataModel.getIDsAndRecipesWhereProductID = getIDsAndRecipesWhereProductID
gatheringDataModel.getIDsAndRecipesWhereProductIDAndBuildingID = getIDsAndRecipesWhereProductIDAndBuildingID

--Override recipe data retrieval interface
gatheringDataModel.getRecipeProductID = getRecipeProductID
gatheringDataModel.getRecipeProductAmount = getRecipeProductAmount
